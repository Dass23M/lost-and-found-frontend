  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 relative overflow-hidden"
        ...
        <div className="relative p-5 rounded-2xl" style={{ background: "rgba(255,255,255,0.1)" }}>
          <p className="text-sm italic mb-3" style={{ color: "rgba(255,255,255,0.8)" }}>
            "I found my lost laptop bag thanks to this platform. Someone had posted it within an hour of me losing it!"
          </p>
        ...
        <div className="w-full max-w-md">
          <div className="card p-8">
            ...
            <p className="text-sm mb-7" style={{ color: "var(--text-muted)" }}>
              ...
              <Link href="/auth/login" style={{ color: "var(--teal-600)" }} className="font-medium hover:underline">
                Sign in
              </Link>
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input type="text" name="name" value={form.name}
                  onChange={handleChange} required placeholder="Your name" className="input"/>
              </div>
              <div>
